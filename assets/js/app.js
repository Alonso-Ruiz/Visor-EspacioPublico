...
var styleManzanasLimatambo = new ol.style.Style({ stroke: new ol.style.Stroke({ color: 'rgba(45, 45, 45, 0.95)', width: 1.6, lineDash: [6, 2, 2, 2], lineCap: 'butt', lineJoin: 'miter' }) });
